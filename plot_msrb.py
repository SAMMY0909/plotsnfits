...
ax1.set_ylim(8,32)
ax1.set_xlabel('$\mu_{r}$ ', fontsize=10)
ax1.set_ylabel('$m_{ab} $ ',fontsize=10)
ax1.spines['right'].set_visible(False) ; ax1.spines['top'].set_visible(False)
ax1.set_xticks([24.5,25,25.5,26,26.5,27]) ; ax1.set_xticklabels(['24.5','25','25.5','26','26.5','27'],rotation=0,fontsize=10)
ax1.grid(False)
...
ax2.set_ylim(8,32)
ax2.set_xlabel('$\mu_{r}$ ', fontsize=10)
ax2.set_ylabel('$m_{ab} $ ',fontsize=10)
ax2.spines['right'].set_visible(False) ; ax2.spines['top'].set_visible(False)
ax2.set_xticks([24.5,25,25.5,26,26.5,27]) ; ax2.set_xticklabels(['24.5','25','25.5','26','26.5','27'],rotation=0,fontsize=10) 
ax2.grid(False)
...
ax3.set_ylim(8,32)
ax3.set_xlabel('$\mu_{r}$ ', fontsize=10)
ax3.set_ylabel('$m_{ab} $ ',fontsize=10)
ax3.spines['right'].set_visible(False) ; ax3.spines['top'].set_visible(False)
ax3.set_xticks([24.5,25,25.5,26,26.5,27]) ; ax3.set_xticklabels(['24.5','25','25.5','26','26.5','27'],rotation=0,fontsize=10) 
ax3.grid(False)
...
ax4.set_ylim(8,32)
ax4.set_xlabel('$\mu_{r}$ ', fontsize=10)
ax4.set_ylabel('$m_{ab} $ ',fontsize=10)
ax4.spines['right'].set_visible(False) ; ax4.spines['top'].set_visible(False)
ax4.set_xticks([24.5,25,25.5,26,26.5,27]) ; ax4.set_xticklabels(['24.5','25','25.5','26','26.5','27'],rotation=0,fontsize=10) ; ax4.xaxis.set_ticks_position('bottom')
ax4.grid(False)
...
ax5.set_ylim(8,32)
ax5.set_xlabel('$\mu_{r}$ ', fontsize=10)
ax5.set_ylabel('$m_{ab} $ ',fontsize=10)
ax5.spines['right'].set_visible(False) ; ax5.spines['top'].set_visible(False)
ax5.set_xticks([24.5,25,25.5,26,26.5,27]) ; ax5.set_xticklabels(['24.5','25','25.5','26','26.5','27'],rotation=0,fontsize=10) ; ax5.xaxis.set_ticks_position('bottom')
ax5.grid(False)
...
ax6.set_ylim(8,32)
ax6.set_xlabel('$\mu_{r}$ ', fontsize=10)
ax6.set_ylabel('$m_{ab} $ ',fontsize=10)
ax6.spines['right'].set_visible(False) ; ax6.spines['top'].set_visible(False)
ax6.set_xticks([24.5,25,25.5,26,26.5,27]) ; ax6.set_xticklabels(['24.5','25','25.5','26','26.5','27'],rotation=0,fontsize=10) ; ax6.xaxis.set_ticks_position('bottom')
ax6.grid(False)
...
ax7.set_ylim(8,32)
ax7.set_xlabel('$\mu_{r}$ ', fontsize=10)
ax7.set_ylabel('$m_{ab} $ ',fontsize=10)
ax7.spines['right'].set_visible(False) ; ax7.spines['top'].set_visible(False)
ax7.set_xticks([24.5,25,25.5,26,26.5,27]) ; ax7.set_xticklabels(['24.5','25','25.5','26','26.5','27'],rotation=0,fontsize=10) 
ax7.grid(False)
...
ax8.set_ylim(8,32)
ax8.set_xlabel('$\mu_{r}$ ', fontsize=10)
ax8.set_ylabel('$m_{ab} $ ',fontsize=10)
ax8.spines['right'].set_visible(False) ; ax8.spines['top'].set_visible(False)
ax8.set_xticks([24.5,25,25.5,26,26.5,27]) ; ax8.set_xticklabels(['24.5','25','25.5','26','26.5','27'],rotation=0,fontsize=10) 
ax8.grid(False)
...
ax9.set_ylim(8,32)
ax9.set_xlabel('$\mu_{r}$ ', fontsize=10)
ax9.set_ylabel('$m_{ab} $ ',fontsize=10)
ax9.spines['right'].set_visible(False) ; ax9.spines['top'].set_visible(False)
ax9.set_xticks([24.5,25,25.5,26,26.5,27]) ; ax9.set_xticklabels(['24.5','25','25.5','26','26.5','27'],rotation=0,fontsize=10)
ax9.grid(False)
