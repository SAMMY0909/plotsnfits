...
plt.title('GALEX FUV-GALEX NUV VS Mean Surface Brightness in KIDS r Band ',fontsize=15)
plt.ylim(5,1)
...
for i, txt in enumerate(n1):
    plt.annotate(txt, (x1[i], y12[i]),rotation=90,xytext=((x1[i]+0.03),y12[i]+1),size=15)
nm1="fuv-nuv_msrb.pdf"
#mm1="fuv-nuv_msrb.png"
plt.savefig(nm1)
#plt.savefig(mm1)
