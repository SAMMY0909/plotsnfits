...
#Pt1
sent1="n= "+str(np.round(x11[0],decimals=2))+", $N_{s}$="+str(n11[0])
...
#Pt2
sent2="n= "+str(np.round(x11[1],decimals=2))+", $N_{s}$="+str(n11[1])
...
#Pt3
sent3="n= "+str(np.round(x11[2],decimals=2))+", $N_{s}$="+str(n11[2])
...
#Pt4
sent4="n= "+str(np.round(x11[3],decimals=2))+", $N_{s}$="+str(n11[3])
...
#Pt5
sent5="n= "+str(np.round(x11[4],decimals=2))+", $N_{s}$="+str(n11[4])
...
#Pt6
sent6="n= "+str(np.round(x11[5],decimals=2))+", $N_{s}$="+str(n11[5])
...
#Pt7
sent7="n= "+str(np.round(x11[6],decimals=2))+", $N_{s}$="+str(n11[6])
...
#Pt8
sent8="n= "+str(np.round(x11[7],decimals=2))+", $N_{s}$="+str(n11[7])
...
#Pt9
sent9="n= "+str(np.round(x11[8],decimals=2))+", $N_{s}$="+str(n11[8])
...
in_pdf="SED_SERI_PLOT.pdf"
#in_png="SED_SERI_PLOT.png"
fig.text(0.95,0.80,"n= Sersic Index, $N_s$= Sample Size in each bin \n $m_{ab}= $ AB Magnitude; Wavelength in Angstorms is in logarithmic scale",rotation=90,fontsize="8")
#fig.tight_layout()
