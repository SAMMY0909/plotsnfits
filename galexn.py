...
#MSRB PLOT
os.chdir("/home/soumyananda/Dropbox/Goswami_REVISED/DATA_FITS_KIDS_GAMA_VST/GALEX_NUV_FITS_6AS/STACKED_IMAGES_MSRB/")
x1=[];y1=[];z1=[];n1=[]
...
plt.title("GALEX NUV AB Magnitude VS $\mu$ in KIDS r band ")
plt.ylim(8,32)
...
nm="trend_galex_nuv_msrb.pdf"
mm="trend_galex_nuv_msrb.png"
plt.savefig(nm)
plt.savefig(mm)

#SERI PLOT
os.chdir("/home/soumyananda/Dropbox/Goswami_REVISED/DATA_FITS_KIDS_GAMA_VST/GALEX_NUV_FITS_6AS/STACKED_IMAGES_SERI/")
x11=[];y11=[];z11=[];n11=[]
num_lines1 = sum(1 for line1 in open('countsinfogalexnuv1.txt'))
df1 = pd.read_table('countsinfogalexnuv1.txt', sep=',', skipinitialspace=False )
...
plt.title('GALEX NUV AB Magnitude VS Sersic Index n',fontsize=8)
plt.ylim(8,32)
...
nm1="trend_galex_nuv_seri.pdf"
mm1="trend_galex_nuv_seri.png"
plt.savefig(nm1)
plt.savefig(mm1)