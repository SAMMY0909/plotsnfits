...
plt.title("SDSS i AB magnitude VS $\mu$ in KIDS r band ")
plt.ylim(8,32)
...
nm="trend_sdss_i_msrb.pdf"
mm="trend_sdss_i_msrb.png"
plt.savefig(nm)
plt.savefig(mm)
...
x11=[];y11=[];z11=[];n11=[]
num_lines1 = sum(1 for line1 in open('countsinfosdssi1.txt'))
df1 = pd.read_table('countsinfosdssi1.txt', sep=',', skipinitialspace=False )
...
plt.title('SDSS i AB magnitude VS Sersic Index n',fontsize=8)
plt.ylim(8,32)
...
nm1="trend_sdss_i_seri.pdf"
mm1="trend_sdss_i_seri.png"
plt.savefig(nm1)
plt.savefig(mm1)